...
//all distances in mm
n1 = 34; //red gear number of teeth. Set to zero if you don't want to print a pinion.
...
mm_per_tooth = 3.25;
thickness    = 10;  // depth of the rack from side-to-side, including backboard if any. The pinion will be this depth minus the backboard_thickness
